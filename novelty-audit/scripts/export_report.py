...
def to_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"**Search Coverage:** {_md_inline(verdict['search_coverage'])}  ",
    ...
    if report.get("minimal_prior_sets"):
        ...
        lines.append("No evidence-bound set of up to three eligible papers covered every critical facet.")
...
def to_html(report: dict[str, Any]) -> str:
    ...
    if not mps_items:
        mps_items.append("<li>No evidence-bound set of up to three eligible papers covered every critical facet.</li>")
...
<header class=\"hero\">
  ...
  <div class=\"axes\">
    ...
    <div><span>Search Coverage</span><strong>{e(verdict.get('search_coverage'))}</strong></div>
