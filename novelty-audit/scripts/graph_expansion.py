    ...
    *,
    ...
    for endpoint_id in (paper_a_id, paper_b_id):
        try:
            ...
            calls.append({"direction": "BACKWARD", "anchor_paper_id": endpoint_id, "returned_count": len(results)})
    ...
    for anchor in anchors:
        ...
        try:
            ...
            calls.append({"direction": "FORWARD", "anchor_paper_id": anchor_id, "returned_count": len(results)})
